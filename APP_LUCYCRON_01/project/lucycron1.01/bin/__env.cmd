...
echo "> help cmd      : command helper"
echo "> help set      : set helper"
echo "> help start    : start helper"
echo "> help for      : for helper"
echo "> help if       : if helper"
echo "> help call     : call helper"
echo "> help shutdown : shutdown helper"
echo "> net /?        : net helper"
echo "> choice /?     : choice helper"
...
echo "> bthprops.cpl        : 블루투스 장치 설정"
echo "> collab.cpl          : 주변 사람 찾기"
echo ""
echo "C:\> dir /s *.msc : 모든 MSC(Microsoft Consol) 파일 찾기"
...
echo "> napclcfg.msg        : NAP(Network Access Protection) 클라이언트 관리자"
